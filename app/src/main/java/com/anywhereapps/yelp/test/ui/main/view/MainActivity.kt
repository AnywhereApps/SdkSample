...
import com.anywhereapps.sdk.model.Business
...
class MainActivity : AppCompatActivity(), ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private val API_KEY = "zEAl9ALZtSge9s_sbLcgGNJ1ahQjM-YAbPAfGdv4bQF_FMWWzzvulRqlCeswQ21gBTq3p2vvJixx-OeNDRywKdira05TzADA2RZ4XWINLUlUetrSxR3icuaow1IfX3Yx"
    ...
    private fun initTestSDK(){
        TestSDK.Builder(API_KEY)
            .enableLogging(true)
            .build()
    }
    ...
    private fun searchResult(){
        ...
        getData(term, mLatitude, mLongitude, radiusInMeter.toString())
    }
    ...
    private fun getData(term : String,latitude : Double, longitude : Double, radius : String){

        viewModel.getEstablishments(term, latitude, longitude, radius).observe(this, Observer {
            it?.let { resource ->
